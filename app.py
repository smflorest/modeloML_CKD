...
o no (**notckd**) usando un modelo de Árbol de Decisión previamente entrenado utilizando machine learning supervisado por clasificacion, con una exactitud del 0.99, y basado en el dataset de UCI Irvine Machine learning repository (https://archive.ics.uci.edu/dataset/336/chronic+kidney+disease). 
""")
st.markdown("""
